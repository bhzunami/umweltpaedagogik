...
class ContactsController < ApplicationController
	...
	def new
		...
		@contact.course << "Umwelttheater Figurenspiel 1: Kompostieren + Littering / 2 Std."
                @contact.course << "Figurenspiel Madame Poubelle, Recycling + vermeiden / 2 Std."
		...
		@contact.course << "Abfallvermeidung in der Kehrichtverbrennung Basel / 3 Std."
                @contact.course << "Abfallmorgen: Vermeiden, Recycling, Littering"
		@contact.course << "Tipps und Hintergründe zum täglichen Abfallvermeiden / 2 Std."
		@contact.course << "Figurenspiel 2:Littering Recycling / 2‒3 Std."
                @contact.course << "Elektroschrott vermeiden und Recycling 2 Std."
